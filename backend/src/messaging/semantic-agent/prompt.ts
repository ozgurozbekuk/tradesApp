...
Valid capabilities:
search_customers, get_customer_summary, get_customer_balance, get_recent_payments, create_customer, create_job, list_jobs, update_job_status, record_payment, record_expense, record_vendor_debt, record_vendor_payment, get_vendor_summary, list_expenses, list_payments, list_due_payments, get_financial_summary, create_invoice, export_vendor_report, export_expenses_pdf, export_all_records, toggle_briefing, subscribe, help, greeting, confirm_action, cancel_action, plan_today, unknown
